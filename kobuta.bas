...
400 ' ***** PLAYER CONTROL *****
410 LOCATE WX(W),WY(W):PRINT "hhh";:S=STICK(0)+STICK(1)+1
420 ON S GOTO 470,430,470,450,470,440,470,460,470
...
530 GOSUB 700
540 GOSUB 1700:C=C+1:IF C>7+((LV=1)*4) THEN C=0:CC=0:FOR I=0 TO 3:D(I)=0:NEXT I
550 NEXT II:RETURN

600 ' ***** CHARACTER GENERATE *****
610 IF (CC<>0 AND INT(RND(1)*(LV*3))=0) OR CC>1-(LV=1) THEN RETURN
...
800 ' ***** INTO HOUSE *****
810 HX(C)=0:HY(C)=223:C(HC(C))=C(HC(C))-1
820 IF DF THEN RETURN 
830 IF HT(C) THEN 1100 ELSE GOSUB 1850:RETURN

1000 ' ***** CHARACTER FALL *****
1010 FOR I=0 TO 32
1020 PUT SPRITE C*2  ,(HX(C),HY(C)+I), 9-HT(C)*4,16+HT(C)*2
1030 PUT SPRITE C*2+1,(HX(C),HY(C)+I),11+HT(C)*4,17+HT(C)*2
1040 SOUND 0,50+I*2:SOUND 1,0:SOUND 8,10+(I\4)
1040 NEXT I:SOUND 8,0
1050 IF HT(C) THEN HX(C)=0:HY(C)=223:C(HC(C))=C(HC(C))-1:GOSUB 1850:RETURN
...
1140 GOSUB 3020
1150 MS=MS+1:LOCATE 24+MS,0:PRINT "X";:GOSUB 1900:IF MS<3 THEN GOSUB 2500 ELSE GM=2
1160 RETURN

1700 ' ***** GAME TIME COUNT *****
1710 T1=T1+1:IF T1>T2 THEN T1=0
1715 'LOCATE 0,0:PRINT USING "##";T1;
1720 RETURN
...
1850 ' ***** SCORE ADD & PRINT *****
1860 SC=SC+1:LOCATE 10,0:PRINT USING "###";SC;
1870 IF SC=20 OR SC=50 THEN LV=LV+1
1880 RETURN

1900 ' ***** ALL SPRITE ERASE *****
1910 FOR I=0 TO 18:PUT SPRITE I,(0,191),0,0:NEXT I:RETURN

2000 ' ***** TITLE *****
2010 DF=1:GOSUB 3500
2020 LV=2:GOSUB 2500
...
2070 GOSUB 500:IF STRIG(0)+STRIG(1)=0 THEN 2070
2080 GOSUB 3000 ' SCREEN MAKE & DEMO
2090 GOSUB 2500 ' LEVEL SET
2100 GM=2:DF=0:LV=1:SC=0:MS=0:RETURN
...
2500 ' ***** LEVEL SET *****
2510 W=0:T1=0:T2=30+((LV=3)*15):C=0:CC=0
2520 FOR I=0 TO 9:HX(I)=0:HY(I)=223:NEXT I
2530 FOR I=0 TO 3:C(I)=0:D(I)=0:NEXT I
2550 RETURN 
...
3510 CLS:GOSUB 1900
3520 LOCATE 4, 0:PRINT "SCORE   0       MISS"
